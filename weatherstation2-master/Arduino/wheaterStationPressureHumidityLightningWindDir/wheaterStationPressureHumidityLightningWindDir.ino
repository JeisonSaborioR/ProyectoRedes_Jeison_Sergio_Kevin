...
char server[] = "192.168.0.100"; //TEC SIRZEE
...
String user = "rojo@tec.ac.cr";
String passWord = "rojo123";
/* //////////////////////////////////////////
...
* //////////////////////////////////////////*/
  ...
  if (client.connect(server, port)) {
    client.println("POST /postMeasure/"+ idStation + "/" +
        ...
        humidityString + "/" + light_lvlString + "/" + winddirString + "/" + windspeedmphString+"/"+ "0"+  "/" + "0"
        +" HTTP/1.1");
