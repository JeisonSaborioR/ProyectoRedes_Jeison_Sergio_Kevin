...
app.use('/scripts',  express.static(__dirname + '/node_modu0les/bootstrap/dist/js/'));
...
//app.use(expressJWT({secret:'access to weather station'}).unless({path:['/authentication']}))

app.get('/authentication',mainCtrl.getUserData);
